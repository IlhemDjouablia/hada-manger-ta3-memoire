...
<script type="text/javascript">
  ...
  color:#0e0e0e8f; "></i><span style=" color: #8041f5ab;">grade </span></div>  
        <div class="row2">    
    <form action="back/grade.php" method="post">
        <input type="hidden" name="idreq" value="<?php echo $idreq; ?>">
        <input type="hidden" name="idst" value="<?php echo $idst; ?>">
        <div id="grade">
        
            <p>Intern 01: <span> ilhéme djouablia</span></p>
            <div class="table__body2">
                <table>
                    <thead>
                    ...
                    <tbody>
                        <tr class="score-card">
                            ...
                            <td><input type="text" name="discipline" class="discipline"></td>
                        </tr>
                        <tr class="score-card">
    <td>Aptitudes au travail et a la manipulation</td>
    <td><input type="number" name="aptitudes" class="aptitudes" step="0.05"></td>
</tr>
<tr class="score-card">
    <td>Initiative /entreprenariat</td>
    <td><input type="number" name="initiative" class="initiative" step="0.05"></td>
</tr>
<tr class="score-card">
    <td>Capacités d'imagination et d'innovation </td>
    <td><input type="number" name="capacites" class="capacites" step="0.05"></td>
</tr>
<tr class="score-card">
    <td>Connaissances acquises sur le terrain de stage</td>
    <td><input type="number" name="connaissances" class="connaissances" step="0.05"></td>
</tr>
<tr class="score-card">
    <td>Note Finale</td>
    <td><input type="number" name="note_finale" class="note-finale" step="0.05" readonly></td>
</tr>

                    </tbody>
                </table>
            </div>
         <div style="display: inline-flex;margin-left: 14cm; margin-top:-90cm; ">
            <a href="grades.php?id=<?=$id?>"  class="create-rq" ><i class="fa-solid fa-arrow-left"></i>&nbsp;back</a>
                <button class="create-rq" > <i class="fa-regular fa-floppy-disk"></i> &nbsp;Save</button>
</div>
        </div>
    </form>
</div>
