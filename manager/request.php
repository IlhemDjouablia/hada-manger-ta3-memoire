...
if (isset($_SESSION['idm']) && isset($_SESSION['namem'])) {
  $emailm = $_SESSION['emailm'];
   $sql = "SELECT * FROM request INNER JOIN student ON student.id_student = request.id_student  where email_manager='$emailm' and state = 50 order by id_req desc";  
...
<div class="table__body">
   ...
   {  ?>
           <tr class="score-card">
              ...
              <td> <br>
                 <a href="consulte.php?id=<?=$row['id_req']?>" data-section="profile"> <button class="rq-btn">CONSULT</button> </a>
