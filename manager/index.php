...
if (isset($_SESSION['idm']) && isset($_SESSION['namem'])) {
  ...
  $sql = "SELECT count(id_req) FROM request WHERE email_manager='$email'and state=50";
  $result = mysqli_query($conn, $sql);
  $row = mysqli_fetch_row($result);
  $_SESSION['request'] = $row[0];
  $sql2 = "SELECT count(id_req) FROM request WHERE email_manager='$email'and state=100";
  $result2 = mysqli_query($conn, $sql2);
  $row2 = mysqli_fetch_row($result2);
  $_SESSION['accepted'] = $row2[0];
  $sql3 = "SELECT count(id_req) FROM request WHERE email_manager='$email'and state=00";
                       ...
                       <div class="box-home">
                           <div class="image-home">
                            ...
                            <div class="content-home">
                             <h3 class="title-home"><i class="fa-thin fa-hand-wave"></i>hello <span style="color:  rgb(96, 106, 247);"><?=$_SESSION['namem']?></span></h3>
                             <span class="post">Internship manager/<?=$_SESSION['companym']?> </span>
            ...
            <br>
                ...
                <div class="row">
                 ...
                 <div class="contain1">
                     ...
                     <img src="about1.png" style="height: 125px ;width:125px ;">
                   <span class="num" data-val="<?=$_SESSION['request']+1?>">00</span>
                   <p class="text">Requests</p>
                 </div>
                 <div class="contain1" >
                     
                     <img src="send2.png" style="height: 125px ;width:125px ;">
                   <span class="num" data-val="<?=$_SESSION['accepted']+1?>">00</span>
                   <p class="text">Accepted</p>
                 </div>
                 <div class="contain1">
                    <img src="loop2.png" style="height: 125px ;width:125px ;">
                    
                   <span class="num" data-val="<?=$_SESSION['refused']+1?>">00</span>
...
<br><br><br>
   ...
   <!--incriment num-->
   <script>let valueDisplays = document.querySelectorAll(".num");
    let interval = 4000;
