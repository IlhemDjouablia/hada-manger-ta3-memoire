                        ...
                        <div class="hhh">
                          <form action="back/editback.php" method="post"  enctype="multipart/form-data" >
                            <div class="jj">
                              ...
                              <div class="ib">
                                <img id="img" src="img/<?=$_SESSION['pm']?>" height="150px" width="150px" style="border-radius: 25px;">
                              </div> 
                                  ...
                                  if (input.files[0])
                                    img.src = URL.createObjectURL(input.files[0]);
                                                            ...
                                                            <div class="ib">
                                                              ...
                                                              <input type="Text" placeholder="Enter your First Name " required name="fname" value="<?=$_SESSION['namem']?>">
                                                            </div>
                                                            <div class="ib">
                                                              <span class="det">Company Name</span>
                                                              <input type="Text" placeholder="Enter your First Name " required name="company" value="<?=$_SESSION['companym']?>">
                                                            </div>
                                                            </div>
                            
                            </div>
                            <a href="#" class="sidebar-link" data-section="profile"><button class='hadjer'>Go Back</button></a>
