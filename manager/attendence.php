...
<script type="text/javascript">
  ...
  color:#0e0e0e8f; "></i><span style=" color: #8041f5ab;"> Attendence </span></div> 
               <div class="table__header">
               <a href="intern.php" data-section="profile"> <button class="create-rq"> <i class="fa-solid fa-arrow-left"></i>&nbsp;back</button> </a>
           
                
           <a href="take.php?id=<?=$id?>" data-section="profile"> <button class="create-rq" style="margin-right: 1cm;">take attendance</button> </a>
                  ...
                  <tr class="score-card">
                     ...
                     <td> <br><?=$row['date']?></td>
                        ...
                        <td> <br>
                                ...
                                <a href="att.php?id=<?=$row['intern_name']?>&date=<?=$row['date']?>" data-section="profile"> <button class="rq-btn"><i class="fa-sharp fa-solid fa-eye fa-bounce"></i></button> </a></td>
