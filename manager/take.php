...
<script type="text/javascript">
  ...
  color:#0e0e0e8f; "></i><span style=" color: #8041f5ab;">Take Attendence </span></div>  
        <div class="table__header">
    <a href="attendence.php?id=<?=$id?>" data-section="profile">
    <button class="create-rq"> <i class="fa-solid fa-arrow-left"></i>&nbsp;back</button>
    </a>
    ...
    <form method="post" action="back/att.php">
    ...
    <div class="table__body">
        ...
        <div class="row">
            <button class="create-rq" type="submit">save</button>
        </div>
    </form>
</div>
