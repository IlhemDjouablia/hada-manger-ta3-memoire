...
if (isset($_SESSION['idm']) && isset($_SESSION['namem'])) {
  ...
  $sql = "SELECT * FROM request WHERE email_manager='$emailm' AND state = 100 GROUP BY intern_name ORDER BY id_req DESC";
...
<script type="text/javascript">
  ...
  color:#0e0e0e8f; "></i><span style=" color: #8041f5ab;"> Internship </span></div>
       ...
       <div class="table__body">
          ...
          {  ?>
                  <tr class="score-card">
                     <td> <br><?=$co=$co+1;?> </td>
                     <td><img src="../head/img/<?=$row['p_comp']?>"> <?=$row['intern_name']?></td>
         
                  
                     <td> <br>
                        <a href="attendence.php?id=<?=$row['intern_name']?>" data-section="profile"> <button class="rq-btn">attendance</button> </a></td>
                        <td> <br>
                        <a href="grades.php?id=<?=$row['intern_name']?>" data-section="profile"> <button class="rq-btn">grades</button> </a></td>
                        <td> <br>
                        <a href="certificate.php?id=<?=$row['intern_name']?>" data-section="profile"> <button class="rq-btn">certificate</button> </a></td>
